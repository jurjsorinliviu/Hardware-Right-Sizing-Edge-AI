"""Regenerate Figure 4: Burgers PDE kappa-sweep improvement curve.
...
plt.tight_layout()
plt.savefig('extracted_figures/figure4_kappa_sweep_NEW.png',
            dpi=200, bbox_inches='tight', facecolor='white')
print('\nSaved: extracted_figures/figure4_kappa_sweep_NEW.png')
