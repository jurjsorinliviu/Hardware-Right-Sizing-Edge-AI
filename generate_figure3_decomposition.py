"""Generate Figure 3: Five-cell orthogonal decomposition framework.
...
ax.text(5.0, -0.3,
        ...
        '\n(residual ≤ 4×10⁻¹⁴, paired bootstrap n=10, Table IV Panel A)',
...
plt.tight_layout()
plt.savefig('extracted_figures/figure3_decomposition_NEW.png',
            dpi=200, bbox_inches='tight', facecolor='white')
print('Saved: extracted_figures/figure3_decomposition_NEW.png')
