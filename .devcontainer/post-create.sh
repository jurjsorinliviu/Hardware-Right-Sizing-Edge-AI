...
echo "   - Generate Figure 2 (24-hour timeline):        python generate_figure2_timeline.py"
echo "   - Generate Figure 3 (decomposition framework): python generate_figure3_decomposition.py"
echo "   - Generate Figure 4 (Burgers κ-sweep curve):   python generate_figure4_kappa_sweep.py"
